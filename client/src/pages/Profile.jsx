...
const Profile = () => {
  ...
  return (
    ...
    <form className="flex flex-col gap-4" >
     ...
     <P className = 'text-sm self-center'>
      {imageError ? (<span className="text-red-700">Error Uploading Image
  ...
  <button className="bg-slate-700 text-white p-3 rounded-lg uppercase hover:placeholder-opacity-95 disabled:bg-opacity-80 ">Update</button>
